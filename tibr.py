...
if day>0:
	if val is 0: # переносить строку если дальше нету результатов, если есть не переносить и писать след результ в одну строку
		print(' ',day,skl(day,2))
...
if minute>0:
	if val is 0:	
		rmin=minute,skl(minute,4);print(rmin[0],rmin[1]) #print('    ',minute,skl(minute,4),end=' ')
